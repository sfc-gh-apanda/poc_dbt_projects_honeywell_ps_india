...
SELECT 'DWS_EDW'     AS object, CASE WHEN COUNT(*) > 0 THEN 'EXISTS' ELSE 'DROPPED' END AS status
FROM INFORMATION_SCHEMA.DATABASES WHERE DATABASE_NAME = 'DWS_EDW'
UNION ALL
SELECT 'DWS_EDWDEV',  CASE WHEN COUNT(*) > 0 THEN 'EXISTS' ELSE 'DROPPED' END
FROM INFORMATION_SCHEMA.DATABASES WHERE DATABASE_NAME = 'DWS_EDWDEV'
UNION ALL
SELECT 'DWS_EDWTEST', CASE WHEN COUNT(*) > 0 THEN 'EXISTS' ELSE 'DROPPED' END
FROM INFORMATION_SCHEMA.DATABASES WHERE DATABASE_NAME = 'DWS_EDWTEST';
