...
Tables:    DWSEDW.DWS_AUDIT.DBT_RUN_LOG
...
{% macro log_run_start() %}
    {% if var('enable_audit_logging', true) %}
        {% set sql %}
            INSERT INTO {{ var('audit_database', 'DWSEDW') }}.{{ var('audit_schema', 'DWS_AUDIT') }}.DBT_RUN_LOG (
            ...
            WHERE NOT EXISTS (
                SELECT 1 FROM {{ var('audit_database', 'DWSEDW') }}.{{ var('audit_schema', 'DWS_AUDIT') }}.DBT_RUN_LOG
