...
CREATE DATABASE IF NOT EXISTS DWSEDW;

CREATE SCHEMA IF NOT EXISTS DWSEDW.DWS_TRAN;
CREATE SCHEMA IF NOT EXISTS DWSEDW.DWS_MASTER;
CREATE SCHEMA IF NOT EXISTS DWSEDW.DWS_REF;

-- ═══════════════════════════════════════════════════════════════════════════════
-- TABLE 1: DIM_CLIENT (Master Data - 30 clients)
-- ═══════════════════════════════════════════════════════════════════════════════

CREATE OR REPLACE TABLE DWSEDW.DWS_MASTER.DIM_CLIENT (
...
INSERT INTO DWSEDW.DWS_MASTER.DIM_CLIENT VALUES
...
CREATE OR REPLACE TABLE DWSEDW.DWS_MASTER.DIM_ACCOUNT (
...
INSERT INTO DWSEDW.DWS_MASTER.DIM_ACCOUNT VALUES
...
CREATE OR REPLACE TABLE DWSEDW.DWS_MASTER.DIM_FUND (
...
INSERT INTO DWSEDW.DWS_MASTER.DIM_FUND VALUES
...
CREATE OR REPLACE TABLE DWSEDW.DWS_REF.DIM_BENCHMARK (
...
INSERT INTO DWSEDW.DWS_REF.DIM_BENCHMARK VALUES
...
CREATE OR REPLACE TABLE DWSEDW.DWS_TRAN.FACT_PORTFOLIO_HOLDINGS (
...
INSERT INTO DWSEDW.DWS_TRAN.FACT_PORTFOLIO_HOLDINGS
WITH date_series AS (
...
CREATE OR REPLACE TABLE DWSEDW.DWS_TRAN.FACT_TRANSACTIONS (
...
INSERT INTO DWSEDW.DWS_TRAN.FACT_TRANSACTIONS VALUES
...
CREATE OR REPLACE TABLE DWSEDW.DWS_TRAN.FACT_NAV_PRICES (
...
INSERT INTO DWSEDW.DWS_TRAN.FACT_NAV_PRICES
WITH date_series AS (
...
CREATE OR REPLACE TABLE DWSEDW.DWS_REF.FACT_FX_RATES (
...
INSERT INTO DWSEDW.DWS_REF.FACT_FX_RATES
WITH date_series AS (
...
SELECT 'DIM_CLIENT'             AS table_name, COUNT(*) AS row_count FROM DWSEDW.DWS_MASTER.DIM_CLIENT
UNION ALL
SELECT 'DIM_ACCOUNT',           COUNT(*) FROM DWSEDW.DWS_MASTER.DIM_ACCOUNT
UNION ALL
SELECT 'DIM_FUND',              COUNT(*) FROM DWSEDW.DWS_MASTER.DIM_FUND
UNION ALL
SELECT 'DIM_BENCHMARK',         COUNT(*) FROM DWSEDW.DWS_REF.DIM_BENCHMARK
UNION ALL
SELECT 'FACT_PORTFOLIO_HOLDINGS',COUNT(*) FROM DWSEDW.DWS_TRAN.FACT_PORTFOLIO_HOLDINGS
UNION ALL
SELECT 'FACT_TRANSACTIONS',     COUNT(*) FROM DWSEDW.DWS_TRAN.FACT_TRANSACTIONS
UNION ALL
SELECT 'FACT_NAV_PRICES',       COUNT(*) FROM DWSEDW.DWS_TRAN.FACT_NAV_PRICES
UNION ALL
SELECT 'FACT_FX_RATES',         COUNT(*) FROM DWSEDW.DWS_REF.FACT_FX_RATES
ORDER BY table_name;
